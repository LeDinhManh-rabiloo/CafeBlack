    ...
    <div class="footer-top-area">
        <div class="container">
            <div class="row row-wrap">
                <div class="col-md-3">
                    <a href="index.html">
                        <img src="{{asset('users/img/faker.ico')}}" alt="logo" title="logo" class="logo">
                    </a>
                ...
                <div class="col-md-3">
                    ...
                    <ul class="thumb-list">
                        <li>
                            <a href="#">
                                <img src="{{asset('users/img/urbex_esch_lux_with_laney_and_laaaaag_70x70.jpg')}}" alt="Image Alternative text" title="Urbex Esch/Lux with Laney and Laaaaag" />
                            </a>
                            <div class="thumb-list-item-caption">
                                <p class="thumb-list-item-meta">Jul 18, 2014</p>
                                <h5 class="thumb-list-item-title"><a href="#">Est non</a></h5>
                                <p class="thumb-list-item-desciption">Tristique interdum ligula sit luctus</p>
                            </div>
                        </li
                    </ul>
                </div>
